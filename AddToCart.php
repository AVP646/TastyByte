...
<body>
  ...
  <script>
    let cartItems = [
      { name: "Shirt - DarkBlue", price: 99, img: "images/1.jpg", quantity: 0 },
      { name: "Shirt - LightGreen", price: 80, img: "images/2.jpg", quantity: 0 },
      { name: "Shirt - Coffee", price: 20, img: "images/3.jpg", quantity: 0 }
    ];
